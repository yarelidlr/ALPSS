...
from alpss.analysis.hel.helpers import _rdp_hel
...
def hel_detection(
    ...
    *,
    ...
    method: str,
    hel_rdp_epsilon: float,
    hel_slope_drop_ratio: float,
    hel_min_plateau_duration: float,
):
    """
...
# ---------------------------------------------------------------------------
# Linear Hybrid HEL detection (HELIX Toolbox v2 algorithm)
# ---------------------------------------------------------------------------
...
def hel_detection_rdp_hybrid(
    ...
    *,
    hel_start_ns: float,
    hel_end_ns: float | None,
    min_velocity: float,
    density: float | None,
    acoustic_velocity: float | None,
    C_L: float | None,
    rdp_epsilon: float,
