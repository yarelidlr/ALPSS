...
def save(
    ...
    **inputs,
    ...
    results_to_save.update({
        ...
        "Velocity at Max Compression Freq Uncertainty": vu_out["peak_velocity_freq_uncert"],
        "Velocity at Max Compression Vel Uncertainty": vu_out["peak_velocity_vel_uncert"],
        "Velocity at Max Tension": vc_out["v_max_ten"],
        "Time at Max Tension": vc_out["t_max_ten"],
        "Velocity at Max Tension Freq Uncertainty": vu_out["max_ten_freq_uncert"],
        "Velocity at Max Tension Vel Uncertainty": vu_out["max_ten_vel_uncert"],
